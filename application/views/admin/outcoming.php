                ...
                <div class="home-tab">
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        ...
                        <div class="btn-wrapper">
                            <a href="Outcoming_report/allTime" class="btn btn-otline-dark"><i class="icon-printer"></i> Print All</a>
                            <a href="Outcoming_report/thisMonth" class="btn btn-otline-dark"><i class="icon-printer"></i> Print This Month</a>
                            <a href="Outcoming_report/thisWeek" class="btn btn-otline-dark"><i class="icon-printer"></i> Print This Week</a>
                            <a href="Outcoming_report/thisDay" class="btn btn-primary text-white me-0"><i class="icon-printer"></i> Print This Day</a>
                        </div>
                    </div>
                                            ...
                                            <div class="card card-rounded">
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <div>
                                                            <h4 class="card-title card-title-dash">Outcoming Report Orders</h4>
...
<script>
    ...
    function getDataTotalIncome() {
        const base_url = window.location.pathname;
        $.ajax({
            url: `${base_url}/getDataTotalOutcome`,
            type: "GET",
            dataType: "json",
            success: function(response) {
                let html;
                ...
                html += ` <tr>
                    	<td colspan="5" class="text-end"><strong><h5>Total Outcome</strong></h5></td>
